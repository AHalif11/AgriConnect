    ...
    <main>
      ...
      <div id="Consumer-dashboard-banner-hero">
        <div id="banner-left" style="background: linear-gradient(108.43deg, rgba(0, 0, 0, 0.6), rgba(0, 0, 0, 0) 100%),
              url(images/consumerDashboard/bannarBig.png) no-repeat center center; background-size: cover;">
        ...
        <div id="banner-right">
          <div id="top" style="background: url(images/consumerDashboard/BGTop.png) no-repeat center center; background-size: cover;">
          ...
          <div id="bottom" style="background: linear-gradient(rgba(0, 38, 3, 0.8), rgba(0, 38, 3, 0.8)), url('images/consumerDashboard/BgBottom.png') no-repeat center center / cover;">
